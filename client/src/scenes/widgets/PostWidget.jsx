...
const PostWidget = ({
  ...
  const patchLike = async () => {
    const response = await fetch(`https://sociohub-cjb0.onrender.com/posts/${postId}/like`, {
      method: "PATCH",
      headers: {
  ...
  const addComment = async () => {
    const response = await fetch(`https://sociohub-cjb0.onrender.com/posts/${postId}/comment`, {
      method: "POST",
      headers: {
        Authorization: `Bearer ${token}`,
        "Content-Type": "application/json",
